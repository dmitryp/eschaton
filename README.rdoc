== SOME THINGS MAY NOT WORK IN THE rails_three BRANCH !

= eschaton

Provides the raw materials for writing google map mashups in Rails by providing a language that is as natural as possible.

== Get the plugin ...

Rails 3 peeps:

  $ rails plugin install git://github.com/yawningman/eschaton.git
  $ rails generate map

Rails 2.3.8 and up peeps:
...
You can do whatever you like with the code, copy it, share it, fork it, use it, don't use it, claim it as your own!